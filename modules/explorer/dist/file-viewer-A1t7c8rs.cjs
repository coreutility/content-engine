"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const d=async t=>({set:async(i,b)=>{const a=(i.data.curr.data.theme||"dark")==="dark",l=i.data.curr.data.files||[],o=i.data.curr.data.activeFile;let r=null;const c=n=>{for(const e of n){if(e.id===o)return e;if(e.children){const s=c(e.children);if(s)return s}}return null};return r=c(l),{r:`
                    <div class="h-full flex flex-col">
                        ...
                        id="${t.f.name("file-tabs")}" class="flex items-center border-b overflow-x-auto scrollbar-thin"
                            ...
                            ${l.filter(e=>e.type==="file").map(e=>{const s=e.id===o;return`
                    ...
                    }`}}});exports.default=d;exports.index=d;exports.renderer=d;
