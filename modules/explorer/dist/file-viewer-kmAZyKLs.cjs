"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const l=async t=>({set:async(i,b)=>{const a=(i.data.curr.data.theme||"dark")==="dark",d=i.data.curr.data.files||[],o=i.data.curr.data.activeFile;let r=null;const c=n=>{for(const e of n){if(e.id===o)return e;if(e.children){const s=c(e.children);if(s)return s}}return null};return r=c(d),{r:`
                    <div class="h-full flex flex-col">
                        ...
                        id="${t.f.name("file-tabs")}" class="flex items-center border-b overflow-x-auto scrollbar-thin"
                            ...
                            ${d.filter(e=>e.type==="file").map(e=>{const s=e.id===o;return`
                        ...
                        <div class="flex-1 overflow-auto p-2 scrollbar-thin">
                            ...
                            <div class="h-full">
                                ...
                                <div id="${t.f.name("file-editor")}" 
                                    class="w-full h-[calc(100%-60px)] font-mono text-sm p-4 rounded border resize-none overflow-auto scrollbar-thin
                    ...
                    }`}}});exports.default=l;exports.index=l;exports.renderer=l;
